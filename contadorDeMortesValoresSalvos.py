...
class CounterApp:
    def __init__(self, root):
        ...
        self.add_key = self.config.get("add_key", keyboard.Key.enter)
        self.sub_key = self.config.get("sub_key", keyboard.Key.backspace)
        self.reset_key = self.config.get("reset_key", keyboard.Key.delete)
    ...
    def save_config(self):
        ...
        with open(CONFIG_FILE, 'w') as file:
            json.dump(config, file, default=lambda o: o.value if isinstance(o, keyboard.Key) else o.char)
